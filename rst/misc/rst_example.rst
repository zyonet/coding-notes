...
bold        `**bold**`                         **bold**
link        ```python-2 <www.python.org>`_``   `python-u-1 <www.python.org>`_
verbatim    ````*````                          ``*``
=========== ================================== ==============================
...
which appear as `<http://www.python.org/>`_ . Note the underscore after the final single quote. Since the full name of the link is not always simple or meaningful, you can specify a label (note the space between the label and link name)::
    ...
    `Pythonxxx <http://www.python.org/>`_

The rendering is now: `Pythonxxx <http://www.python.org/>`_.
...
.. literalinclude:: ../../_static/downloads/sample.py
    :linenos:
    :language: python
...
Substitutions  are defined as follows::
    ...
    .. _Pythonxxx: http://www.python.org/

and to refer to it, use the same syntax as for the internal links: just insert the alias in the text (e.g., ``Pythonxxx``,  which appears as Pythonxxx_ ).
...
::
    ...
    :download:`download samplet.py <../../_static/downloads/sample.py>`

gives :download:`download sample.py <../../_static/downloads/sample.py>`
